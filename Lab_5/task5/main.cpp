...
/*
 * 5. Напишіть програму, яка використовує <QTextStream> для зчитування даних з
 ...
 замінюючи усі входження певного слова на інше слово. Слова для заміни програма
 повинна запитувати у користувача.
*/
...
int main(int argc, char *argv[]) {
  ...
  QFile fileRead("C:/Kyrylo/dstu/pzs/software_engineering/5 "
                 "CSVReadOnlyWithDisplay/text.txt");
  if (!fileRead.open(QIODevice::ReadOnly | QIODevice::Text))
    return 1;
  QTextStream in(&fileRead);

  QFile fileWrite("C:/Kyrylo/dstu/pzs/software_engineering/5 "
                  "CSVReadOnlyWithDisplay/output.txt");
